...
1)  PaO~2~ \pm Aa gradient (if arterial gas)    
...
`pH`, `PaCO<sub>2</sub>` and `PaO<sub>2</sub>` are all measured directly.  The [other parameters](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5873626/) are calculated:  

- `HCO<sub>3</sub>act` = what the bicarb is in the sample  
- `HCO<sub>3</sub>std` = what the bicarb would have been if PaCO<sub>2</sub> was normal (i.e. under standard conditions: T37, fully oxygenated, PaCO<sub>2</sub> 5.3 kPa)
