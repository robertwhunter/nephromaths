...
**Inherited dRTA** caused by mutations in A-IC proteins (see [here](https://pubmed-ncbi-nlm-nih-gov.eux.idm.oclc.org/28233610/) & [here](https://pubmed-ncbi-nlm-nih-gov.eux.idm.oclc.org/33914889/)):  
...
(Intriguingly, there is a [case report](https://www-jci-org.eux.idm.oclc.org/articles/view/188807) of gain-of-function H+-ATPase mutations causing a renal tubular alkalosis!)  
...
- prefer K-citrate for the reasons [here](#supplements), prefer frequent dosing  
